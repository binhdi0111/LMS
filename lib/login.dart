...
import 'package:dangnhap_lms/home_page.dart';
...
class Detail_Login extends State<Login> {
                ...
                child: Row(
                  children: [
                    ...
                    const Text(
                      'Nhớ mật khẩu',
                      style: TextStyle(
                          fontSize: 14, color: Color.fromRGBO(26, 26, 26, 1), fontFamily: 'static/Inter-Regular.ttf' , fontWeight: FontWeight.w400),
                    ),
                    const Expanded(child: Text('')),
                    TextButton(
                        onPressed: () {
                          Get.to(Password_retrieval());
                        },
                        child: const Text(
                          'Quên mật khẩu?',
                          style: TextStyle(
                ...
                child: ElevatedButton(
                    onPressed: () {
                      setState(() {
                        ...
                        int? lengthUserName = controllerUserName?.text.length;
                        int? lengthPassword = controllerPassword?.text.length;
